...
<template>
  ...
  >
    <div class="">
      <div class="grid grid-rows-5 lg:grid-rows-7 lg:grid-cols-2 m-5">
        ...
        <div class="row-span-1 lg:row-span-3 lg:mt-14">
        ...
        <div class="row-span-1 lg:row-span-1 lg:row-start-5 topic-text-03">
