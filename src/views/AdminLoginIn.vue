            ...
            <form>
              ...
              <div class="mb-6">
                <input
                  ...
                  :class="[
                    ...
                    loginUser.email.error ? 'border-red-600' : '',
                  ]"
                  id="email"
                  placeholder="Email address"
                  required
                  v-model="loginUser.email.value"
                />
              </div>
              ...
              <div class="mb-6">
                <input
                  ...
                  :class="[
                    'form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none',
                    loginUser.password.error ? 'border-red-600' : '',
                  ]"
                  id="password"
                ...
                <div class="form-group form-check">
                  <input
                    ...
                    :class="[
                      ...
                      loginUser.rememberMe.error ? 'border-red-600' : '',
                    ]"
                    id="remeberMeCheckbox"
                    v-model="loginUser.rememberMe.value"
                  />
                  <label
                    class="form-check-label inline-block text-gray-800"
                    for="remeberMeCheckbox"
                    >Remember me</label
                  >
                </div>
