...
const submitForm = async () => {
  try {
    ...
    const response = await httpResource.post(
      'api/staff/vehicle/features/quickAdd',
      {
        name: form?.name,
      }
    )
        ...
        <div class="add-car">
          <SectionMain>
            <CardBox form @submit.prevent="submit">
              <SectionTitleLineWithButton :icon="mdiCarEstate" title="Add Feature" main>
              </SectionTitleLineWithButton>
              <FormField label="Feature" help="">
