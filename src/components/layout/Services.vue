<template>
    <div class="menu-sub" @click="isOpen = !isOpen">
        ...
        <transition name="fade" apear>
            <ul class="dropdown-menu" v-if="isOpen">
                <li class="dropdown dropdown-submenu dropend" @click="isOpen = !isOpen">
                    <a class="dropdown-item dropdown-toggle" href="#" data-bs-toggle="dropdown">Auction
                        <img src="../../assets/images/dropdown/plus.svg" alt="" /></a>
                    <ul class="dropdown-menu" apear>
                        <li class="nav-item"><a class="dropdown-item" href="services.html">Auction Calendar</a></li>
                        <li class="nav-item"><a class="dropdown-item" href="services2.html">Auction Guide</a></li>
                        <li class="nav-item"><a class="dropdown-item" href="services2.html">Auction Vs Stock</a></li>
                        <li class="nav-item"><a class="dropdown-item" href="services2.html">Auction Houses</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item dropdown-toggle" href="#"
                        data-bs-toggle="dropdown">Certifications
                        <img src="../../assets/images/dropdown/plus.svg" alt="" /></a>
                    <ul class="dropdown-menu" apear>
                        <li class="nav-item"><a class="dropdown-item" href="services.html">EAA</a></li>
