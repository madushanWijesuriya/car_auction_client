  ...
  >
    ...
    >
      <div class="flex flex-col w-full">
        <div class="flex flex-row md:flex-wrap w-full justify-between">
          <div class="w-full flex-col">
            ...
            <div
              class="hidden md:flex w-full items-end justify-center lg:justify-end pt-2"
            >
              <div class="flex flex-row gap-2 items">
                <span
                  ><svg
                    width="12"
                    height="14"
          ...
          <div class="flex w-full flex-col md: items-end">
            ...
            <p class="font-shipping-price truncate">
      ...
      <div class="md:hidden flex w-full items-end lg:justify-end py-2 truncate">
        <div class="flex flex-row gap-2 items truncate">
          <span
            ><svg
              width="12"
              height="14"
